...
Gui, 1:Add, Tab2, hwndhEdit +Theme -Background -Wrap AltSubmit gTab_Click x2 y50 w275 h358  vTab1,窗口|控件|V/A文本|样式表|操作|IE元素|IE操作
;==========================================================
Gui, 1:Tab, 1 ;以下创建的控件属于第一个标签页
Gui, 1:Add, ListView, hwndhEdit NoSort Grid NoSortHdr -Multi gListView_DoubleClick vListView1  x8 y75 w263 h306 , 属性|值
...
gui,1:+Resize +MaximizeBox 
;==========================================================
Gui, 1:Tab, 2 ;以下创建的控件属于第2个标签页
Gui, 1:Add, ListView, hwndhEdit4 NoSort Grid NoSortHdr -Multi gListView_DoubleClick vListView2 x8 y75 w263 h158 , 属性|值
...
LV_ModifyCol(2, 190)
;......................
Gui, 1:Add, ListView, hwndhEdit3 AltSubmit Checked Grid NoSort -Multi HwndLV4H gListView_DoubleClick vListView4 x8 y233 w263 h170 ,控件列表|ID|句柄|文本|

;==========================================================
Gui, 1:Tab, 3 ;以下创建的控件属于第3个标签页 []
Gui, 1:Add, Edit, hwndhEdit5 HScroll ReadOnly x8 y75 w263 h162 vVisible_text,这里将显示的是可见文本
Gui, 1:Add, Edit, hwndhEdit6 HScroll ReadOnly x8 y237 w263 h162 vHidden_text,这里将显示的是全部文本
;==========================================================
...
Gui, 1:Add, Edit,  hwndhEdit7 HScroll ReadOnly x8 y95 w263 h305 vGenerate_text
;==========================================================
...
Gui, 1:Add, Edit, hwndhEdit8 ReadOnly x8 y326 w263 h75 vEdit1
Radio1Text:=
Radio2Text:=
;==========================================================
...
Gui, 1:Add, Edit,  hwndhEdit1 HScroll ReadOnly x8 y95 w263 h305 vIeGenerate_text
